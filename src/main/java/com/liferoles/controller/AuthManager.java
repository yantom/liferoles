...
public class AuthManager {
	 ...
	 * 
	 * @param accessingUser
	 *            user object populated with password and email
	...
	public String issueNewToken(Long userId) throws LiferolesRuntimeException {
		...
		return Jwts.builder().setSubject(userId.toString()).setId(jit.toString())
	...
	public void useResetToken(String resetToken, User u) throws TokenValidationException, LiferolesRuntimeException {
		...
		try {
			Query query = em.createNativeQuery(
					"update passwordreset set used = true where tokenhash = :tokenHash and appuser_id = :userId and used = false and expirationdate > :dateNow");
